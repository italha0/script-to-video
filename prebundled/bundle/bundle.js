...
const MessageBubble = ({ msg, appearSec, first, last }) => {
  ...
  return /* @__PURE__ */ react.createElement("div", { style: { display: "flex", justifyContent: msg.sent ? "flex-end" : "flex-start", marginBottom: 6, transform: `translateY(${translateY}px) scale(${scale})`, opacity: progress } }, /* @__PURE__ */ react.createElement("div", { style: bubbleStyle }, displayText));
};
const TypingBubble = ({ startSec, endSec, sent }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  ...
  const dot = (i) => {
    ...
    return /* @__PURE__ */ react.createElement("div", { key: i, style: { width: 6, height: 6, borderRadius: 3, background: sent ? "#fff" : "#6E6E73", transform: `scale(${scale})`, transition: "transform 0.15s linear" } });
  };
  return /* @__PURE__ */ react.createElement("div", { style: { display: "flex", justifyContent: sent ? "flex-end" : "flex-start", marginBottom: 6, transform: `translateY(${translateY}px)`, opacity: progress } }, /* @__PURE__ */ react.createElement("div", { style: { display: "flex", gap: 6, background: sent ? "#007AFF" : "#E5E5EA", padding: "8px 14px", borderRadius: 18 } }, [0, 1, 2].map(dot)));
};
const Keyboard = ({ startSec, endSec, currentInputText, activeChar }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const startFrame = Math.round(startSec * fps);
  ...
  const inputDisplay = currentInputText && currentInputText.length > 0 ? /* @__PURE__ */ react.createElement("span", null, currentInputText, showCaret && caretBlink ? /* @__PURE__ */ react.createElement("span", { style: { borderLeft: "2px solid #007AFF", marginLeft: 2 } }) : null) : /* @__PURE__ */ react.createElement("span", { style: { opacity: 0.4 } }, "iMessage", showCaret && caretBlink ? /* @__PURE__ */ react.createElement("span", { style: { borderLeft: "2px solid #007AFF", marginLeft: 2 } }) : null);
  return /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", left: 0, right: 0, bottom: 0, transform: `translateY(${translateY}px)`, background: "#D1D4DA", borderTop: "1px solid #B4B7BD", fontFamily: fontStack } }, /* @__PURE__ */ react.createElement("div", { style: { display: "flex", alignItems: "center", padding: "6px 8px", gap: 8, background: "#F2F2F7" } }, /* @__PURE__ */ react.createElement("div", { style: { width: 32, height: 32, borderRadius: 16, background: "#C7C7CC", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 } }, "\u{1F4F7}"), /* @__PURE__ */ react.createElement("div", { style: { flex: 1, background: "#FFFFFF", borderRadius: 16, padding: "6px 12px", color: "#000", fontSize: 16, minHeight: 32, display: "flex", alignItems: "center" } }, inputDisplay), /* @__PURE__ */ react.createElement("div", { style: { width: 32, height: 32, borderRadius: 16, background: "#C7C7CC", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 } }, "\u{1F3A4}")), /* @__PURE__ */ react.createElement("div", { style: { padding: "4px 6px 8px" } }, keyRows.map((row, i) => /* @__PURE__ */ react.createElement("div", { key: i, style: { display: "flex", justifyContent: "center", marginBottom: i === keyRows.length - 1 ? 0 : 6 } }, row.map(renderKey)))));
};
const StatusBar = ({ batteryLevel = 100 }) => {
  const clamped = Math.min(100, Math.max(0, batteryLevel));
  return /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 0, left: 0, right: 0, height: 44, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 18px", fontSize: 15, fontWeight: 600, fontFamily: fontStack, zIndex: 30 } }, /* @__PURE__ */ react.createElement("div", null, "9:41"), /* @__PURE__ */ react.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ react.createElement("div", { style: { display: "flex", alignItems: "flex-end", gap: 2 } }, [4, 7, 10, 13].map((h, i) => /* @__PURE__ */ react.createElement("div", { key: i, style: { width: 3, height: h, background: "#000", borderRadius: 1 } }))), /* @__PURE__ */ react.createElement("div", { style: { position: "relative", width: 18, height: 14 } }, /* @__PURE__ */ react.createElement("svg", { viewBox: "0 0 20 14", width: 18, height: 14 }, /* @__PURE__ */ react.createElement("path", { d: "M10 13c.9 0 1.6-.7 1.6-1.6S10.9 9.8 10 9.8 8.4 10.5 8.4 11.4 9.1 13 10 13Z", fill: "#000" }), /* @__PURE__ */ react.createElement("path", { d: "M3.3 6.6a9.2 9.2 0 0 1 13.4 0l-1.2 1.2a7.5 7.5 0 0 0-11 0L3.3 6.6Z", fill: "#000" }), /* @__PURE__ */ react.createElement("path", { d: "M6.2 9.3a5.3 5.3 0 0 1 7.6 0l-1.2 1.2a3.6 3.6 0 0 0-5.2 0l-1.2-1.2Z", fill: "#000" }))), /* @__PURE__ */ react.createElement("div", { style: { position: "relative", width: 28, height: 14, border: "2px solid #000", borderRadius: 4, display: "flex", alignItems: "center", padding: "0 3px", boxSizing: "border-box" } }, /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 3, right: -5, width: 3, height: 8, background: "#000", borderRadius: 1 } }), /* @__PURE__ */ react.createElement("div", { style: { width: `${clamped}%`, height: 6, background: clamped < 20 ? "#FF3B30" : "#000", borderRadius: 2, transition: "width 0.3s" } }))));
};
const NavigationHeader = ({ contactName }) => /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 44, left: 0, right: 0, height: 52, background: "#F2F2F7", borderBottom: "1px solid #C7C7CC", display: "flex", alignItems: "center", padding: "0 12px", fontFamily: fontStack, zIndex: 20 } }, /* @__PURE__ */ react.createElement("div", { style: { fontSize: 17, color: "#007AFF" } }, "Back"), /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", left: "50%", transform: "translateX(-50%)", fontSize: 17, fontWeight: 600 } }, contactName || "Contact"));
const DeliveredBelow = ({ startSec }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const startFrame = Math.round(startSec * fps);
  if (frame < startFrame) return null;
  ...
  return /* @__PURE__ */ react.createElement("div", { style: { display: "flex", justifyContent: "flex-end", marginTop: 4, transform: `translateY(${translateY}px)`, opacity } }, /* @__PURE__ */ react.createElement("div", { style: { fontSize: 12, color: "#8E8E93", fontFamily: fontStack } }, "Delivered"));
};
const MessageConversation = ({ messages, typingBeforeIndices, contactName, batteryLevel }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const entries = [];
  let prevEnd = 0;
  ...
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { background: "#000", fontFamily: fontStack, display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ react.createElement("div", { style: { width: 360, height: 780, background: "#FFFFFF", borderRadius: 48, position: "relative", overflow: "hidden", boxShadow: "0 8px 24px rgba(0,0,0,0.4)", border: "6px solid #000" } }, /* @__PURE__ */ react.createElement(StatusBar, { batteryLevel }), /* @__PURE__ */ react.createElement(NavigationHeader, { contactName }), /* @__PURE__ */ react.createElement("div", { style: { position: "absolute", top: 96, left: 0, right: 0, bottom: 0, padding: "0 12px", paddingBottom: 4 + keyboardVisibleHeight, display: "flex", flexDirection: "column", justifyContent: "flex-end", boxSizing: "border-box", zIndex: 5 } }, entries.map((entry) => {
    var _a, _b;
    ...
    return /* @__PURE__ */ react.createElement(react.Fragment, { key: msg.id }, typingIndicatorStart !== void 0 && typingIndicatorEnd !== void 0 && /* @__PURE__ */ react.createElement(TypingBubble, { startSec: typingIndicatorStart, endSec: typingIndicatorEnd, sent: false }), /* @__PURE__ */ react.createElement(MessageBubble, { msg, appearSec, first, last }), deliveredStartSec != null && lastSent && lastSent.idx === idx && /* @__PURE__ */ react.createElement(DeliveredBelow, { startSec: deliveredStartSec }));
  })), keyboardStart != null && /* @__PURE__ */ react.createElement(Keyboard, { startSec: keyboardStart, endSec: keyboardEnd, currentInputText, activeChar })));
};
